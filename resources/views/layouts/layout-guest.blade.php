...
<head>
    <meta charset="utf-8" />
    <title>Dashboard - Virtu Bank</title>
        ...
        <div class="main-menu" style="background: #6a1b9a;">
            ...
            <div class="logo-box">
                ...
                <a class='logo-light' href='{{ route('dashboard') }}'>
                    <img src="assets/images/logo-light-2.png" alt="logo" class="logo-lg" height="28">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='#'>
                            <span class="menu-icon"><i class="mdi mdi-cash-check"></i></span>
                            <span class="menu-text"> Liste des virements </span>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='#'>
                            ...
                            <span class="menu-text">Carte stratégique</span>
                        </a>
                    </li>
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="ms-1 d-none d-md-inline-block">
                                    Dassoah Maixent <i class="mdi mdi-chevron-down"></i>
                                </span>
                            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="d-none d-md-flex gap-4 align-item-center justify-content-md-end">
                                <p class="mb-0">Design & Develop by <a href="#" target="_blank">Dassoah Maixent</a> </p>
                            </div>
                        </div>
                    </div>
                </div>
